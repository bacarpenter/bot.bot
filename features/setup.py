...
def bot_setup(message, settings):
    ...
    if setup_stage == 0:
        ...
        rList.append(
            f"Rename the downloaded file exactly `firebase-adminsdk.json` and place it in the `{__file__}/secrets/` directory on your computer. This file should be kept secret, so don't post it online.")  # __file__ from https://stackoverflow.com/a/56799977/13013466. Thanks!
